...
class Objective6(Objective):
    ...
    def __call__(self, trial):
        ...
        z   = trial.suggest_int("z", - 1_000_000, 1_000_000)
        ...
        roc_auc = Objective6.metric(self.path, self.configs[0]['n_samples'], self.configs[0]['seps'][0], z)
